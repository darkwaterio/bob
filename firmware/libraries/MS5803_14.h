...
//    float mmHg() const				{return mmHgPress;}
    ...
    unsigned long Z1val() const 	{return Z1;}
    unsigned long Z2val() const		{return Z2;}
...
//    float mmHgPress;	// Store pressure in mm of mercury
    unsigned long Z1;	// Store D1 value
    unsigned long Z2;	// Store D2 value
